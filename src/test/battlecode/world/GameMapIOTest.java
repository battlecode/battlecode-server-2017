...
public class GameMapIOTest {
    ...
    public void testClearMap() throws IOException {
      ...
      //mapBuilder.saveMap("src/test/battlecode/world/resources/clearMap.map17");

        GameMap readMap = GameMapIO.loadMapAsResource(loader, "battlecode/world/resources", "clearMap", teamMapping);
    ...
    public void testDefaultNeutralTreesMap() throws IOException {
      ...
      //battlecode.schema.GameMap actualMap = mapBuilder.build();
      //mapBuilder.saveMap("src/test/battlecode/world/resources/neutralTreeMap.map17");

        GameMap readMap = GameMapIO.loadMapAsResource(loader, "battlecode/world/resources", "neutralTreeMap", teamMapping);
    ...
    public void testDefaultBodiesMap() throws IOException {
      ...
      //battlecode.schema.GameMap actualMap = mapBuilder.build();
      //mapBuilder.saveMap("src/test/battlecode/world/resources/neutralBodyMap.map17");

        GameMap readMap = GameMapIO.loadMapAsResource(loader, "battlecode/world/resources", "neutralBodyMap", teamMapping);
