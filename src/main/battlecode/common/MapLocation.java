...
/**
 * This class is an immutable representation of two-dimensional coordinates in
 * the battlecode world.
 */
public final class MapLocation implements Serializable, Comparable<MapLocation> {
    ...
    /**
     * Creates a new MapLocation representing the location with the given
     * coordinates.
     *
     * @param x
    ...
    /**
     * A comparison function for MapLocations. Smaller rows go first, with ties
     * broken by smaller columns.
     *
     * @param other
     *            the MapLocation to compare to.
    ...
    /**
     * Two MapLocations are regarded as equal iff their coordinates are the
     * same. {@inheritDoc}
     */
    @Override
     ...
     * Note that squares cannot be adjacent to themselves.
     *
     * @param location
     *            the location to test
     * @return true if the given location is adjacent to this one, or false if
     *         it isn't
     */
    ...
    /**
     * Returns the Direction from this MapLocation to <code>location</code>. If
     * the locations are equal this method returns Direction.OMNI. If
    ...
    /**
     * Returns a new MapLocation object representing a location one square from
     * this one in the given direction.
     *
     * @param direction
     *            the direction to add to this location
     * @return a MapLocation for the location one square in the given direction,
     *         or this location if the direction is NONE or OMNI
     */
    ...
    /**
     * Returns a new MapLocation object representing a location {@code multiple}
    ...
    /**
     * Returns a new MapLocation object translated from this location by a fixed
     * amount
     *
     * @param dx
     ...
     * @return the new MapLocation that is the translated version of the
     *         original.
     */
    ...
    /**
     * Returns a new MapLocation object representing a location one square from
     * this one in the opposite of the given direction.
     *
     * @param direction
    ...
    /**
     * Returns an array of all MapLocations within a certain radius squared of a
     * specified location (cannot be called with radiusSquared greater than
     * 100).
     *
     * @param center
     *            the center of the search
     * @param radiusSquared
     *            the radius of the search, which must be at most 100.
     * @return all MapLocations (both on the map and outside the map) within
     *         radiusSquared distance of center.
     * @throws IllegalArgumentException
     *             if the radiusSquared is greater than 100 or is negative.
     */
    public static MapLocation[] getAllMapLocationsWithinRadiusSq(MapLocation center, int radiusSquared) {
        ...
        if (radiusSquared > 100 || radiusSquared < 0) {
            throw new IllegalArgumentException(
                    "radiusSquared argument for getAllMapLocationsWithinRadiusSq cannot be greater than 100 or negative. However, since Battlecode is open source, you are free to use the source code of this method to implement it yourself.");
        }
