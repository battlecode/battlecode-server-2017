...
public enum RobotType {
	...
	//isbuilding, spawn-source, build-dep, ore cost, turns cost, supply upkeep, hp, attack, range, movement delay, attack delay, loading delay, cooldown delay, sight range, bytecode limit
    BEAVER      (false,                  HQ, null, 100,  20, 20,  30,  4,  5, 2, 2, 1, 1, 24, 10000),
    COMPUTER    (false, TECHNOLOGYINSTITUTE, null,  10,  25,  5,   1,  0,  0, 8, 0, 0, 0, 24, 10000),
    SOLDIER     (false,            BARRACKS, null,  60,  15, 10,  40,  8,  5, 2, 2, 1, 1, 24, 10000),
    BASHER      (false,            BARRACKS, null,  80,  20, 10,  64,  5,  2, 2, 1, 0, 0, 24, 10000),
    MINER       (false,        MINERFACTORY, null,  50,  20, 15,  50,  3,  5, 2, 2, 2, 1, 24, 10000),
    DRONE       (false,             HELIPAD, null, 120,  30,  5,  80,  8, 10, 1, 3, 0, 0, 24, 10000),
    TANK        (false,         TANKFACTORY, null, 200,  50, 30, 160, 20, 15, 2, 3, 2, 2, 24, 10000),
    COMMANDER   (false,       TRAININGFIELD, null, 100,  80, 10, 120,  8, 10, 2, 1, 0, 0, 24, 10000),
