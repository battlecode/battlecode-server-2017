...
public enum RobotType {
     ...
     * @battlecode.doc.robottype
     */
    RECRUIT         (GARDENER,  10, 70,  100,   1,   1,   2,   5,  10,   2, 10000),
    //                              HP    BC   BR   BS   AP   SR  BSR  STR   BCL
    /**
     ...
     * @battlecode.doc.robottype
     */
    SOLDIER         (GARDENER,  10, 80,  130,   1,   1.5f,   2,   5,  10,   2, 10000),
    //                              HP    BC   BR     BS    AP   SR   BSR  STR   BCL
    /**
     ...
     * @battlecode.doc.robottype
     */
    TANK            (GARDENER, 10,  125,  300,   2,   2f,   5,   5,  10,  1.5f, 10000),
    //                              HP    BC     BR   BS    AP   SR  BSR    STR   BCL
    /**
     ...
     * @battlecode.doc.robottype
     */
    SCOUT           (GARDENER,  10, 80,   80,   1,   1,   1,   7,  20,  (float)2.5, 20000),
    //                              HP    BC   BR   BS   AP   SR  BSR         STR   BCL
    ;
