...
//            	special map, don't check size constraints
    ...
    public GameWorld createGameWorld(String teamA, String teamB, long[][] archonMemory) {
        ...
        nm.createVoid(gw.getBaseHQ(Team.A).getLocation(), GameConstants.HQ_COW_SCARE_MANHATTAN_RANGE);
        nm.createVoid(gw.getBaseHQ(Team.B).getLocation(), GameConstants.HQ_COW_SCARE_MANHATTAN_RANGE);
