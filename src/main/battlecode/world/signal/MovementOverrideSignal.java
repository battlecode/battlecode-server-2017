...
/**
 * Signifies that a robot was moved by a user override -- i.e., it should warp
 * to the new location without an animation
 *
 * @author Matt
 */
public class MovementOverrideSignal extends Signal {
     ...
     *
     * @param robot
     *            the ID of the robot that was moved by the user
     * @param newLoc
     *            the robot's new location
     */
