...
/**
 * Instruments a class. See InstrumenterASMImpl for more info on what this
...
public class RoboAdapter extends ClassVisitor implements Opcodes {
     ...
     *
     * @param cv
     *            the ClassVisitor that should be used to read the class
     * @param teamPackageName
     *            the package name of the team for which this class is being
     *            instrumented
     * @param debugMethodsEnabled
     *            whether debug methods are enabled for this class
     * @param silenced
     *            whether System.out should be silenced for this class
     */
    public RoboAdapter(final ClassVisitor cv, final String teamPackageName, final boolean debugMethodsEnabled,
            boolean silenced, boolean checkDisallowed) {
    ...
    public void visit(final int version, final int access, final String name, final String signature,
        ...
        for (int i = 0; i < interfaces.length; i++) {
            interfaces[i] = ClassReferenceUtil.classReference(interfaces[i], teamPackageName, silenced,
                    checkDisallowed);
        }
        String newSuperName;
    ...
    public MethodVisitor visitMethod(int access, final String name, final String desc, final String signature,
        ...
        if (exceptions != null) {
            for (int i = 0; i < exceptions.length; i++) {
                exceptions[i] = ClassReferenceUtil.classReference(exceptions[i], teamPackageName, silenced,
                        checkDisallowed);
            }
        }
        ...
        // return mv == null ? null : new RoboMethodAdapter(mv, className, name,
        // desc, teamPackageName, debugMethodsEnabled, silenced,
        // checkDisallowed);
        return mv == null ? null
                : new RoboMethodTree(mv, className, access, name, desc, signature, exceptions, teamPackageName,
                        debugMethodsEnabled, silenced, checkDisallowed);
    }
    ...
    public FieldVisitor visitField(int access, String name, String desc, String signature, Object value) {
        ...
        FieldVisitor fv = cv.visitField(access, name,
    ...
    public void visitOuterClass(String owner, String name, String desc) {
        ...
        super.visitOuterClass(ClassReferenceUtil.classReference(owner, teamPackageName, silenced, checkDisallowed),
                name, ClassReferenceUtil.methodSignatureReference(desc, teamPackageName, silenced, checkDisallowed));
    }
    ...
    public void visitInnerClass(String name, String outerName, String innerName, int access) {
        ...
        super.visitInnerClass(ClassReferenceUtil.classReference(name, teamPackageName, silenced, checkDisallowed),
                ClassReferenceUtil.classReference(outerName, teamPackageName, silenced, checkDisallowed), innerName,
                access);
    }
