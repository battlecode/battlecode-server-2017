...
class WaitNotifyLock implements Lock {
	...
	private class WaitNotifyCondition implements Condition {
		...
		public boolean await(long time, java.util.concurrent.TimeUnit unit) { return false; }
		public long awaitNanos(long nanosTimeout) { return 0; }
		public void awaitUninterruptibly() {}
		public boolean awaitUntil(java.util.Date deadline) { return false; }
	...
	public boolean tryLock(long time, java.util.concurrent.TimeUnit unit) { return false; }
