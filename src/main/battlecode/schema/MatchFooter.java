...
public final class MatchFooter extends Table {
  ...
  public long totalRounds() { int o = __offset(6); return o != 0 ? (long)bb.getInt(o + bb_pos) & 0xFFFFFFFFL : 0; }
  ...
  public static void addTotalRounds(FlatBufferBuilder builder, long totalRounds) { builder.addInt(1, (int)totalRounds, 0); }
