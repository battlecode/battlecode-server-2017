...
- Each robot also has an individual 'supply' count. A robot's supply decreases as it performs actions or runs code. Robots without supply will stil be able to perform actions and/or run code, but with penalties to action frequency and/or bytecode limit.
